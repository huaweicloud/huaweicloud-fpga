...
+ For HTTPS connections, run the `git clone https://github.com/huaweicloud/huaweicloud-fpga.git` command to download the suite.

+ For SSH connections, run the `git clone git@github.com:huaweicloud/huaweicloud-fpga.git` command to download the suite.

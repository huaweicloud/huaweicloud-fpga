...
<ul>
<li><a href="#sec-3-4">3.4. <b>AEI_Register.cfg File Configuration Description</b></a></li>
</ul>
<ul>
<li><a href="#sec-3-5">3.5. <b>AEI_Register.sh Script Operation Instructions</b></a></li>
</ul>
</li>
...
- AEI_Register.cfg  
  This file is used to configure the upload mode of the .bit file generated during compilation and the name of the OBS bucket. For details, see [AEI_Register.cfg File Configuration Description](#sec-3-4).
...
```
  ...
  Note: **PR verification** and **bit file generation ** are implemented in AEI_Register.sh. (For details, see [AEI_Register.cfg File Configuration Description](#sec-3-4).)  
  **PR verification** and **bit file generation** can also be implemented in a single step. For details, see single-step execution description in [build.sh Script Operation Instructions](#sec-3-2).  

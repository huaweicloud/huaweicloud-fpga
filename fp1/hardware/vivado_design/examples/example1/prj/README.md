...
The structure of the prj folder of the Example 1 is as follows:
...
- usr_prj_cfg  
  This file is used to configure user-defined information about the example 1 project. For details, see [usr_prj_cfg Operation Instructions](#sec-3-1).

# usr_prj0 Simulation User Guide
...
<ul>
<li><a href="#sec-1">1. <b>Executing Compilation and Simulation of usr_prj0</b></a>
<ul>
...
Run the `make comp` command to compile a user project. The following is the command for compiling usr_prj0:
...
Run the `make run` command to execute the user project simulation. Specify the name of the test case. The following command is used to execute the **sv_demo_001** test case of **usr_prj0**:
...
Run the `make wave` command to debug a user project. Specify the name of the test case. The following command is used to debug the **sv_demo_001** test case of **usr_prj0**:
...
Users need to create test cases by themselves. The name of the test case must be the same as the name of the folder created by the user. Users can copy the existing test cases in the example or create new ones.

...
function Usage
{
    ...
    echo "-----------------------------example------------------------------"
    echo "sh run.sh vadd /home/fp1/hardware/sdaccel_design/examples/vadd_rtl/prj/bin/vadd.hw.xilinx_huawei-vu9p-fp1_4ddr-xpr_4_1.xclbin"
    echo "                               or                                 "
    echo "sh run.sh vadd ./vadd.hw.xilinx_huawei-vu9p-fp1_4ddr-xpr_4_1.xclbin"
	echo "------------------------------------------------------------------"
}

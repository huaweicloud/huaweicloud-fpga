...
bool PowerMetrics::findCurrents()
{
    ...
    {
        metrics.currents.push_back( xcldev::get_val_int( m_cpath, currentFiles.at( i ).c_str() ) );
    }
...
bool PowerMetrics::findVoltages()
{
    ...
    {
        metrics.voltages.push_back( xcldev::get_val_int( m_vpath, voltageFiles.at( i ).c_str() ) );
    }

...
extern "C" {
    ...
    struct xclAXIErrorStatus {
      unsigned long mErrFirewallTime[3];
      unsigned mErrFirewallStatus[3];
    };
    ...
    XCL_DRIVER_DLLESPEC int xclGetAXIErrorStatus(xclDeviceHandle handle, xclAXIErrorStatus *info);
